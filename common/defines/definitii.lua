...
NDefines.NMilitary.PLAN_PROVINCE_LOW_VP_DEFENSE_IMPORTANCE = 1.0     -- 2.0 vanilla | For area defense VP orders, use this value for relative importance
NDefines.NMilitary.PLAN_PROVINCE_MEDIUM_VP_DEFENSE_IMPORTANCE = 1.0  -- 5.0 vanilla | see above
NDefines.NMilitary.PLAN_PROVINCE_HIGH_VP_DEFENSE_IMPORTANCE = 1.0   -- 8.0 vanilla | see above
NDefines.NMilitary.PLAN_PROVINCE_CAPITAL_DEFENSE_IMPORTANCE = 1.0 --50.0 vanilla | For area defense VP orders, boost importance value with this if it's the capital
NDefines.NMilitary.PLAN_PROVINCE_LOW_VP_IMPORTANCE_FRONT = 1.0 -- 2.0 vanilla | Used when calculating the calue of fronts in the battle plan system
NDefines.NMilitary.PLAN_PROVINCE_MEDIUM_VP_IMPORTANCE_FRONT = 1.0 -- 2.25 vanilla | Used when calculating the calue of fronts in the battle plan system
...
NDefines.NMilitary.PLAN_AREA_DEFENSE_COAST_NO_FORT_IMPORTANCE = 1.0-- Used when calculating the value of defense area provinces for the battle plan system
NDefines.NMilitary.PLAN_AREA_DEFENSE_HAS_RAIL_IMPORTANCE = 1.0	-- Used when calculating the value of defense area provinces for the battle plan system
NDefines.NMilitary.PLAN_AREA_DEFENSE_HAS_SUPPLY_NODE = 1.0		-- Used when calculating the value of defense area provinces for the battle plan system
NDefines.NMilitary.PLAN_AREA_DEFENSE_FACILITY = 1.0               -- Used when calculating the value of defense area provinces for the battle plan system
NDefines.NMilitary.PLAN_STICKINESS_FACTOR = 100.0					-- Factor used in unitcontroller when prioritizing units for locations
NDefines.NMilitary.PLAN_EXECUTE_CAREFUL_LIMIT = 20                -- When looking for an attack target, this score limit is required in the battle plan to consider province for attack
